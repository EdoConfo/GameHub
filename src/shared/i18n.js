...
const DICT = {
  it: {
    ...
    'table.empty': 'Svuota il tavolo',
    'table.emptySure': 'Svuota davvero',
    ...
    'packs.newSub': 'Scrivi le tue parole',
    'packs.inPlay': 'Usa in partita',
    ...
    'mw.rules.goddessDesc': 'Ce n’è una per giro, estratta a caso tra chi è ancora in gioco. Se al voto c’è un pareggio, decide lei chi eliminare. Al giro dopo ne esce un’altra.',
    ...
    'mw.goddess.round': '{name} è la Dea della giustizia di questo giro.',
  ...
  en: {
    ...
    'table.emptySure': 'Really empty it',
    ...
    'packs.newSub': 'Write your own words',
    'packs.inPlay': 'Use in play',
    ...
    'mw.rules.goddessDesc': 'One per round, drawn at random among whoever is still in. If the vote ties, she decides who goes. Next round another one is drawn.',
    ...
    'mw.goddess.round': '{name} is this round’s Goddess of Justice.',
