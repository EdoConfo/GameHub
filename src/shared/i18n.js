...
const DICT = {
  it: {
    ...
    'mw.rules.minorityDesc': 'I civili devono essere più degli impostori (Undercover + Mister White): con 3–4 giocatori 1 impostore, con 5–6 fino a 2, con 7–8 fino a 3, e così via.',
    'mw.rules.suggested': 'Consigliati',
    'mw.rules.suggestedDesc': 'Circa 4 impostori ogni 10 giocatori: un Mister White (due da 11 in su), il resto Undercover.',
    ...
    'mw.rules.step1Desc': 'Il telefono fa il giro del tavolo: ognuno vede in privato la sua parola (o scopre di essere Mister White).',
    'mw.rules.step2': '2 · Indizi',
    'mw.rules.step2Desc': 'A turno, in senso orario, ognuno dice a voce una parola collegata alla propria. Non scriverla. Non comincia mai un Mister White.',
    ...
    'mw.rules.winCivili': 'Se eliminano tutti gli impostori (Undercover + Mister White).',
    ...
    'mw.deal.youAreMrWhite': 'Sei Mister White',
    ...
    'mw.vote.guessTitle': '{name} è Mister White!',
    ...
    'mw.results.mrWhiteWin': 'Vince Mister White',
    ...
    'mw.results.recMrWhite': 'Mister White ha indovinato',
  ...
  en: {
    ...
    'mw.rules.minorityDesc': 'Civilians must outnumber the impostors (Undercover + Mister White): with 3–4 players 1 impostor, with 5–6 up to 2, with 7–8 up to 3, and so on.',
    'mw.rules.suggested': 'Suggested',
    'mw.rules.suggestedDesc': 'About 4 impostors per 10 players: one Mister White (two from 11 up), the rest Undercover.',
    ...
    'mw.rules.step1Desc': 'The phone goes round the table: everyone sees their own word in private (or finds out they are Mister White).',
    'mw.rules.step2': '2 · Clues',
    'mw.rules.step2Desc': 'In turn, clockwise, everyone says out loud one word linked to their own. Don’t write it down. A Mister White never starts.',
    ...
    'mw.rules.winCivili': 'If they eliminate every impostor (Undercover + Mister White).',
    ...
    'mw.deal.youAreMrWhite': 'You are Mister White',
    ...
    'mw.vote.guessTitle': '{name} is Mister White!',
    ...
    'mw.results.mrWhiteWin': 'Mister White wins',
    ...
    'mw.results.recMrWhite': 'Mister White guessed',
